...
private:
    ...
    static int globalIdCounter; // Static counter for auto-generation

public:
    // Constructor auto-generates ID if not specified
    Ticket(string name) {
...
// Initialize the static global ID counter starting from 1000
